...
const FileUpload = () => {
    ...
    const { isLoading, result, error, checkSensitiveContent, checkSensitiveMedia } = useSensitiveContentDetection(
            ...
            <div className="flex flex-1 gap-4">
                ...
                <div className="flex flex-col flex-1">
                    ...
                    <Card className="p-6 flex-1 mt-4">
                        ...
                        {selectedType === "Text" && (
                            <p className="text-gray-700 whitespace-pre-wrap">{inputValue}</p>
                        )}
